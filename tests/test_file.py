...
class TestClass(unittest.TestCase):
    ...
    def test_1_fileUpload(self):
        try:
            ...
            if response.code == 201:
                ...
                Utils.wait_for_condition(lambda: self.service.get("/individual-study/dummy.csv") is not None, timeout=Utils.get_timeout(10))
                assert True
            else:
                assert False
    ...
    def test_6_changeDeletedStatus(self):
        ...
        assert Utils.wait_for_condition(check_status, timeout=Utils.get_timeout(10)), "File status did not propagate to DELETED"
    ...
    def test_8_createFolder(self):
        try:
            ...
            if response.code == 201:
                ...
                assert Utils.wait_for_condition(check_status, timeout=Utils.get_timeout(10)), "Folder status did not propagate to DELETED"
