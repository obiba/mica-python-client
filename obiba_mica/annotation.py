...
class AnnotationService:
    ...
    def create_writer(self, outputFile: str = None):
        ...
        writer = csv.DictWriter(file, fieldnames=["study", "dataset", "name", "index", "label", "annotation"], escapechar='"', quotechar='"', quoting=csv.QUOTE_ALL)
                    ...
                    if "attributes" in var:
                        ...
                        for attr in var["attributes"]:
                            if "namespace" in attr:
                                ...
                                writer.writerow({"study": var["studyId"], "dataset": var["datasetId"], "name": var["name"], "index": str(var["index"]), "label": label, "annotation": tag})
