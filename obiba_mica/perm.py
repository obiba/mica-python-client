...
class PermissionService:
    ...
    def add_permission(self, id, type: str, subject: str, permission: str):
        ...
        """
        uri = UriBuilder(self._get_resource_path(id)).query("type", type.upper()).query("role", self.map_permission(permission)).query("principal", subject).build()
...
class ProjectPermissionService(PermissionService):
    ...
    def add_arguments(cls, parser):
        super().add_permission_arguments(parser)
